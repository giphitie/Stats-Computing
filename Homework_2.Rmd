...
```{r, out.width = "65%", fig.cap = " Problem 1, Question 1", message=FALSE, warning=FALSE, echo=TRUE,fig.show='hold'}
...
```{r , out.width = "70%", fig.cap = " Problem 3, Question 1", message=FALSE, warning=FALSE, echo=TRUE,fig.show='hold'}
