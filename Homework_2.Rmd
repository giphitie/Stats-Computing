...
```{r part1, out.width = "60%", fig.cap = " Part 1", message=FALSE, warning=FALSE, echo=TRUE,fig.show='hold'}

knitr::include_graphics(c("D:/WashU/First Year/Sem1/SDS5071_AdvLinearModel/Homework/HW2/Q1.pdf","D:/WashU/First Year/Sem1/SDS5071_AdvLinearModel/Homework/HW2/Q1b.pdf")) 
...
```{r, out.width = "60%", fig.cap = " Part 1", message=FALSE, warning=FALSE, echo=T,fig.show='hold'}
...
```{r , out.width = "60%", fig.cap = " Problem 2", message=FALSE, warning=FALSE, echo=TRUE,fig.show='hold'}
...
# Generate n uniform random numbers between 0 and 1
  u <- runif(n)  
# Use the inverse CDF of the Cauchy distribution to simulate x 
  x <- tan(pi * (u - 0.5))  
  return(x) # return x
}
...
# Generate n standard normal random numbers as x1
  X1 <- rnorm(n)
...
```{r, warning=FALSE, message=FALSE, fig.cap= "Plot showing the true, inverse cdf and ratio of normals approach of simulating cauchy random number",  out.width = "85%"}
...
#inverse_cdf = inv_cdf_cauc(10000)

#ratio_of_stan_normals = ratio_of_norms_cauc(10000)
...
ggplot() +
  # True Cauchy CDF
  geom_line(data = data_true, aes(x = x, y = cdf), color = "blue", size = 1, linetype = "solid", alpha = 0.5) +
  # CDF from inverse CDF method
  geom_line(data = empirical_cdfs$inverse , aes(x = x, y = cdf), color = "red", size = 1, linetype = "dashed", alpha = 0.8) +
  # CDF from ratio of normals method
  geom_line(data =  empirical_cdfs$ratio, aes(x = x, y = cdf), color = "green", size = 1, linetype = "dotted", alpha = 0.8) +   # Restrict x-axis range
  xlim(-10, 10) +
...
# Print results
#cat("Empirical proportion of acceptances:", acceptance_rate, "\n")
#cat("Empirical proportion of rejections:", 1 - acceptance_rate, "\n")


```

\begin{center} The Empirical proportion of acceptance is `r round(acceptance_rate,3)`  \end{center}
