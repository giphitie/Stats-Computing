...
# Output the results
 data_result <- data.frame("Exact value of m(x)" = exact_mx, "Laplace approximation of m(x)" = laplace_mx, "Absolute error" =absolute_error)
...
# Output result table
result_data <- data.frame("Mixing Probability" = p,"Mean of component 1 (mu1)" = mu1, "Standard deviation of component 1 (sigma1)" = sigma1, "Mean of component 2 (mu2)" = mu2,"Standard deviation of component 2 (sigma2)" = sigma2)
